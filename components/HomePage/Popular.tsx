...
export default function Popular() {
  return (
    ...
    <div className="max-w-[400px] md:max-w-2xl lg:max-w-4xl xl:max-w-7xl mx-auto mt-8 mb-16">
      ...
      <SmallCart photo={benzema} name={'Ava Wilson'} autor={'CNN Sport'} date={'23 June 2023'} description={'Summer transfer window: The biggest moves so far as Saudi Arabia becomes major factor'}/>
      <SmallCart photo={food} name={'William Mitchell'} autor={'Scientific Jurnalist'} date={'23 June 2023'} description={'Lab-grown meat is coming. Here`s everything you need to know'}/>
      <SmallCart photo={stock} name={'James Roberts'} autor={'Stock exchange journalist'} date={'23 June 2023'} description={'Global markets slide as recession fears grip investors'}/>
      </div>
    </div>
    </div>
  );
