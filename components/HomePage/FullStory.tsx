      ...
      <div className="max-w-[400px] md:max-w-2xl lg:max-w-4xl xl:max-w-7xl mx-auto mt-4 md:mt-8 mb-16">
        <div className="grid md:flex gap-6 bg-white">
          <div className="md:w-1/2 text-black p-4 grid">
            ...
            <h2 className="text-2xl lg:text-4xl font-bold mb-2 mt-6">
              British Museum apologizes after using translator`s work in China
              exhibition without pay or acknowledgment
            </h2>
            <p className="text-gray-400">
              When the British Museum launched its “China`s hidden century”
              exhibition last month, writer and translator Yilin Wang began
              getting confusing messages from her peers.{" "}
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-10 mt-6 md:mt-16 px-4">
          ...
          <SmallCart
            photo={nba}
            name={"Liam Carter"}
            autor={"Sport Reporter"}
            date={"12 June 2023"}
            description={
              "Victor Wembanyama taken by the San Antonio Spurs with first pick of NBA Draft"
            }
          />
        </div>
      </div>
