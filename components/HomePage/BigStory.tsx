    ...
    <div className="max-w-[400px] md:max-w-4xl xl:max-w-7xl mx-auto mt-4 mb-4 md:mb-24 justify-center flex lg:justify-normal lg:flex-none">
      <div className="grid lg:flex gap-6 bg-white">
        <div className="w-[350px] md:w-[550px] xl:w-[800px] mb-6 md:mb-0 pl-0 md:pl-3">
          <div className="font-bold">
            <h1 className="text-2xl lg:text-4xl mb-6">
              ...
              Senators press Google, Meta and Twitter on whether their layoffs
              could imperil 2024 election
            </h1>
          </div>
          ...
          <p className="text-gray-500 mt-2 px-1 text-sm">
            Three US senators are pressing Facebook-parent Meta, Google-parent
            Alphabet and Twitter about whether their layoffs may have hindered
            the companies` ability to fight the spread of misinformation ahead
            of the 2024 elections..
          </p>
          <p className="text-black font-bold text-xl mt-4 px-1">
            In a letter to the companies dated Tuesday, the lawmakers warned
            that reported staff cuts to content moderation and other teams could
            make it harder for the companies to fulfill their commitments to
            election integrity.
          </p>
        ...
        <div className="xl:w-[450px] text-black grid">
          <SmallCartv2
            photo={bird}
            description="`Bird Planet` showcases birds like you`ve never seen them before"
          />
          <SmallCartv2
            photo={home}
            description="Inside the world of SAOTA: The South African architects designing elite homes"
          />
          <SmallCartv2
            photo={trap}
            description="Biden taps Dr. Mandy Cohen for top role as next CDC director"
          />
        </div>
      </div>
    </div>
