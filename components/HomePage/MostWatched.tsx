      ...
      <div className="grid md:flex gap-4 bg-white justify-center md:justify-start">
        <div className="w-[300px] md:w-[400px] xl:w-[700px] px-2">
          ...
          <div className="bg-white text-white text-base mt-3 flex rounded-xl justify-between w-[300px] xl:w-[660px] px-1">
            <div className='grid'>
              <span className="text-black font-semibold mb-1">By Isabella Wright</span>
            ...
            <p className='text-black mt-2 text-xl font-bold pl-0 md:pl-1'>Opinion: Biden rolls out the red carpet for a controversial world leader.</p>
            <p className='text-gray-500 font-normal text-md mt-4 pl-0 md:pl-1'>The images the world will see this week as Indian Prime Minister Narendra Modi visits the United States could serve as a turning point in one of the world`s most important relationships. That, at least, is the potential for this eventful week. <span className='text-black font-bold'>Read more...</span></p>
        </div>
        <div className="md:w-[500px] text-black grid xl:grid-cols-2 gap-16 mt-6 md:mt-0">
          <SmallCartv3 photo={nfl} description='NFL star Aaron Rodgers credits psychedelics for improving his performance on the football field' date={'20 June 2023'}/>
          <SmallCartv3 photo={fit} description='What you should know about muscle memory to help you stay fit' date={'20 June 2023'}/>
          <SmallCartv3 photo={ocean} description='What we know about the ocean`s depths — and why it`s so risky to explore it' date={'20 June 2023'}/>
          <SmallCartv3 photo={lufthansa} description='Lufthansa sold six A380s to Airbus. Then things went a little wrong' date={'20 June 2023'}/>
        </div>
      </div>
    </div>
  );
