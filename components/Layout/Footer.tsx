...
export default function Footer() {
  return (
    <>
      <hr className="w-[270px] md:w-[650px] lg:w-[900px] xl:w-[1250px] mx-auto mt-4 border" />
      <footer className="bg-white text-center lg:text-left mt-2 md:max-w-3xl lg:max-w-7xl mx-auto">
        <div className="px-10 md:px-0 md:pl-6 pt-3 text-left">
          <div className="grid md:grid-cols-5 gap-5 md:gap-32">
            <div className="md:w-40 lg:w-56">
              ...
              <p className=" text-slate-400 text-sm xl:text-md ml-0 md:ml-1 text-center md:text-left">
                Stay informed and inspired with our news hub. Discover the
                latest stories, trends, and insights in just a few clicks.
                Explore now!
              </p>
            </div>
            <div className="text-slate-400 text-center md:text-left">
              ...
              <div className="text-sm xl:text-lg ml-0 md:ml-1">
                {["About", "Our journalists", "Work", "Contact"].map(
                  (item, index) => (
