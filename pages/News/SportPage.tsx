...
const SportsHeadlines: React.FC<Props> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (countryCode) {
      const apiUrl = `https://newsapi.org/v2/top-headlines?country=${countryCode}&category=sports&apiKey=${process.env.NEXT_PUBLIC_NEWS_KEY_1}`;
      try {
  ...
  return (
    <>
        <Head>
          <title>News App | Sport News </title>
