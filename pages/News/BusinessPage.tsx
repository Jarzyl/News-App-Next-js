...
const BusinessHeadlines: React.FC<Props> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (countryCode) {
      const apiUrl = `https://newsapi.org/v2/top-headlines?country=${countryCode}&category=business&apiKey=${process.env.NEXT_PUBLIC_NEWS_KEY_1}`;
      try {
  ...
  return (
    <>
        <Head>
          <title>News App | Business News </title>
      ...
      <form onSubmit={handleSubmit}>
        <input
          ...
          className="border border-gray-300 rounded-2xl p-2 mr-2 focus:outline-none text-xl text-gray-400 mb-4"
        />
        <button
          type="submit"
          disabled={isLoading}
