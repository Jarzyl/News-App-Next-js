...
const HealthHeadlines: React.FC<Props> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (countryCode) {
      const apiUrl = `https://newsapi.org/v2/top-headlines?country=${countryCode}&category=health&apiKey=${process.env.NEXT_PUBLIC_NEWS_KEY_1}`;
      try {
  ...
  return (
    <>
        <Head>
          <title>News App | Health News </title>
          <meta name="description" content="Generated by create next app"/>
          <link rel="icon" type="image/jpg" href="news.png"/>
        </Head>
        <NewsBar/>
        <h1 className="text-cyan-400 text-center text-xl md:text-3xl mt-16">Stay up to date with our health news!</h1>
...
export default HealthHeadlines;
